...
INSERT INTO `__new_daily_book_stats`("user_id", "day", "book_id", "minutes_read", "last_active") SELECT "user_id", "day", "book_id", "minutes_read", "last_active" FROM `daily_book_stats`;--> statement-breakpoint
